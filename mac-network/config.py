...
def parseArgs():
    ...
    parser.add_argument("--encType",                default = "RNN",               choices = ["RNN", "GRU", "LSTM", "MiGRU", "MiLSTM"], help = "encoder RNN type")
    ...
    ##### word embeddings 
    parser.add_argument("--wrdEmbDim",              default = 100, type = int,      help = "word embeddings dimension") 
    parser.add_argument("--wrdEmbRandom",           action = "store_false",          help = "initialize word embeddings to random (normal)")
